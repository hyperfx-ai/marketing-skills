...
This file gives Claude Code guidance for working in this repository. The contents mirror [`AGENTS.md`](./AGENTS.md); both files are kept in sync so any agent (Claude Code, Codex, Cursor, etc.) gets the same instructions.
