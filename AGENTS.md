...
| [`competitor-intel`](./skills/competitor-intel) | Research competitors across web, SEO, social, and optional Xquik Apify Actor routes. Produce battle cards, weekly digests, comparison-page input, and board updates. |
| [`customer-research`](./skills/customer-research) | Mine Reddit, YouTube comments, review sites, X, and TikTok for customer language. Includes optional Xquik Apify Actor routes. |
